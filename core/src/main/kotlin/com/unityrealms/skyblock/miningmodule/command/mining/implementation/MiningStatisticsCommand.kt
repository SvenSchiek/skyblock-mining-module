...
import com.unityrealms.skyblock.miningmodule.menu.implementation.MiningStatisticsMenu

import org.bukkit.entity.Player

/** Opens the player's mining statistic menu. */
class MiningStatisticsCommand(private val permission: String) : Command {
  ...
  override fun execute(player: Player, argumentArray: Array<String>): Boolean {
    ...
    MiningStatisticsMenu(player.uniqueId).open(player)
    return true
  }
